...
```
asset pageC.bundle.js 1.69 KiB [emitted] [minimized] (name: pageC)
asset pageA.bundle.js 1.68 KiB [emitted] [minimized] (name: pageA)
asset pageB.bundle.js 1.68 KiB [emitted] [minimized] (name: pageB)
