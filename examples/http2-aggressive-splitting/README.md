...
asset 4dc7849baa9df07a64fa.js 25.5 KiB [emitted] [immutable] (name: main)
asset 240695e376cb5c5982ba.js 15.3 KiB [emitted] [immutable]
chunk (runtime: main) 4dc7849baa9df07a64fa.js (main) 8.58 KiB (javascript) 4.89 KiB (runtime) [entry] [rendered]
  > ./example main
...
asset b246e83e1488a754e72f.js 8.55 KiB [emitted] [immutable] [minimized] (name: main) 1 related asset
asset da217cb663ea7fd34015.js 4.71 KiB [emitted] [immutable] [minimized] 1 related asset
chunk (runtime: main) b246e83e1488a754e72f.js (main) 8.58 KiB (javascript) 4.9 KiB (runtime) [entry] [rendered]
  > ./example main
